...
>> Using Bayes' theorem we find P(A|B), where A is the event of being an identical twin and B is the event of being a twin, to be (5/17). Note that P(A) = 1/300, P(B) = 1/125 + 1/300, and P(B|A) = 1. 
